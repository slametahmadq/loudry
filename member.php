        ...
        <div class="table-responsive">
            ...
            <table class="table m-0">
                ...
                <tbody>
                    ...
                    $select = mysqli_query($koneksi, "SELECT * from member");
            ...
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" aria-label="Text input with radio button" value="Pria"
                            disabled>
                    </div>
                    <div class="input-group mt-3">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" aria-label="Text input with radio button" value="Wanita"
                            disabled>
                    </div>
            </div>
            <div class="form-group">
...
if (isset($_POST['btn-simpan'])) {
    ...
    $nohp = $_POST['nohp'];
    $nik = $_POST['nik'];
    $koneksi->query("INSERT INTO member values 
  ('','$nama','$alamat','$jk','$nohp','$nik')");
